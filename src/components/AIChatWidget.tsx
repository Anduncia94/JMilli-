...
import { Send, Bot, User, Trash2, MessageSquare, X } from 'lucide-react';
...
export default function AIChatWidget({ userId }: AIChatWidgetProps) {
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-gray-200/60 dark:border-gray-700/60 shadow-2xl flex flex-col z-50 animate-slide-up">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 text-white dark:text-gray-900 rounded-full shadow-2xl hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center z-50"
        title={t.chat.title}
      >
        {isOpen ? (
          <X className="w-7 h-7" />
